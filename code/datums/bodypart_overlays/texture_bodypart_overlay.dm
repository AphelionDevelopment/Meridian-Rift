...
/datum/bodypart_texture/mesh/proc/should_modify(image/appearance)
	...
	return appearance_layer == BODY_ADJ_LAYER || appearance_layer == BODY_FRONT_LAYER || appearance_layer == BODY_BEHIND_LAYER || appearance_layer == ABOVE_BODY_FRONT_HEAD_LAYER // APHELION EDIT CHANGE - Tails - ORIGINAL: return appearance_layer == BODY_ADJ_LAYER || appearance_layer == BODY_FRONT_LAYER || appearance_layer == BODY_BEHIND_LAYER

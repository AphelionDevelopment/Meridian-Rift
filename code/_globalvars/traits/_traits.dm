...
GLOBAL_LIST_INIT(traits_by_type, list(
	...
	/obj/item/toy/plush/nova = list(
		...
		"TRAIT_RECYCLE_LIKE_ITEM" = TRAIT_RECYCLE_LIKE_ITEM,
		...
		"TRAIT_SHIP_PRIMARY_COLOUR" = TRAIT_SHIP_PRIMARY_COLOUR,
		"TRAIT_SHIP_SECONDARY_COLOUR" = TRAIT_SHIP_SECONDARY_COLOUR,
		...
		"TRAIT_SHOW_ALL_WIRES" = TRAIT_SHOW_ALL_WIRES,
		"TRAIT_ADMIN_REACHABLE" = TRAIT_ADMIN_REACHABLE,
		"TRAIT_ADMIN_STEALTH" = TRAIT_ADMIN_STEALTH,
		"TRAIT_ADMIN_WALLHACKS" = TRAIT_ADMIN_WALLHACKS,
		"TRAIT_BABEL_CLOTHING" = TRAIT_BABEL_CLOTHING,
		"TRAIT_BABEL_LISTENER" = TRAIT_BABEL_LISTENER,
		"TRAIT_REVEAL_WIRES_ITEM" = TRAIT_REVEAL_WIRES_ITEM,

...
DEFINE_BITFIELD(bodyshape, list(
	...
	// NOVA EDIT ADDITION
	"BODYSHAPE_CUSTOM" = BODYSHAPE_CUSTOM,
	"BODYSHAPE_HIDE_SHOES" = BODYSHAPE_HIDE_SHOES,
	"BODYSHAPE_ALT_FACEWEAR_LAYER" = BODYSHAPE_ALT_FACEWEAR_LAYER,
	"BODYSHAPE_TAUR_GENERIC" = BODYSHAPE_TAUR_GENERIC,
	"BODYSHAPE_TAUR_SNAKE" = BODYSHAPE_TAUR_SNAKE,
	"BODYSHAPE_TAUR_PAW" = BODYSHAPE_TAUR_PAW,
	"BODYSHAPE_TAUR_HOOF" = BODYSHAPE_TAUR_HOOF,
	"BODYSHAPE_TAUR_BIG_LEGS" = BODYSHAPE_TAUR_BIG_LEGS,
	"BODYSHAPE_TAUR_BIG_LEGS_STANCED" = BODYSHAPE_TAUR_BIG_LEGS_STANCED,
	// NOVA EDIT END
))

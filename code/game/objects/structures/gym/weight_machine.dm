...
/obj/structure/weightmachine/process(seconds_per_tick)
	...
	user.adjust_sprint_stamina_loss(stamina_exhaustion * seconds_per_tick) // APHELION EDIT CHANGE - SPRINT-STAMINA - ORIGINAL: user.adjust_stamina_loss(stamina_exhaustion * seconds_per_tick)

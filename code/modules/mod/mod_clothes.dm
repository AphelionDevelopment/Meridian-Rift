...
/obj/item/clothing/head/mod/Initialize(mapload)
	...
	// AddElement(/datum/element/equipment_bodypart_texture, BODY_ZONE_HEAD, /datum/bodypart_texture/mesh/space) // APHELION EDIT REMOVAL - MOD suits already have their own bespoke masking system
...
/obj/item/clothing/suit/mod/Initialize(mapload)
	. = ..()
	ADD_TRAIT(src, TRAIT_NO_SPEED_POTION, INNATE_TRAIT)
	// AddElement(/datum/element/equipment_bodypart_texture, BODY_ZONE_CHEST, /datum/bodypart_texture/mesh/space) // APHELION EDIT REMOVAL - MOD suits already have their own bespoke masking system

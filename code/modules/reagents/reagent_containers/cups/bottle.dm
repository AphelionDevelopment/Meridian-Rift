...
/obj/item/reagent_containers/cup/bottle/traitor/Initialize(mapload)
	. = ..()
	extra_reagent = pick(/datum/reagent/toxin/polonium, /datum/reagent/toxin/histamine, /datum/reagent/toxin/formaldehyde, /datum/reagent/toxin/venom, /datum/reagent/medicine/fentanyl, /datum/reagent/toxin/cyanide)
...
/obj/item/reagent_containers/cup/bottle/fentanyl
	...
	list_reagents = list(/datum/reagent/medicine/fentanyl = 30)

...
/obj/item/toy/basketball/proc/on_spin(mob/living/user)
	...
	addtimer(CALLBACK(user, TYPE_PROC_REF(/mob/living, adjust_sprint_stamina_loss), STAMINA_COST_SPINNING), 1.5 SECONDS) // APHELION EDIT CHANGE - SPRINT-STAMINA - ORIGINAL: addtimer(CALLBACK(user, TYPE_PROC_REF(/mob/living/carbon/, adjust_stamina_loss), STAMINA_COST_SPINNING), 1.5 SECONDS)
...
/obj/item/toy/basketball/proc/on_equipped_mob_disarm(mob/living/baller, mob/living/stealer, zone, obj/item/weapon)
	...
	disarm_chance += (baller.get_sprint_stamina_loss() - stealer.get_sprint_stamina_loss()) / 2 // APHELION EDIT CHANGE - SPRINT-STAMINA - ORIGINAL: disarm_chance += (baller.get_stamina_loss() - stealer.get_stamina_loss()) / 2
	...
	baller.adjust_sprint_stamina_loss(STAMINA_COST_DISARMING) // APHELION EDIT CHANGE - SPRINT-STAMINA - ORIGINAL: baller.adjust_stamina_loss(STAMINA_COST_DISARMING)
...
/obj/item/toy/basketball/interact_with_atom_secondary(atom/interacting_with, mob/living/baller, list/modifiers)
	...
	baller.adjust_sprint_stamina_loss(STAMINA_COST_SHOOTING) // APHELION EDIT CHANGE - SPRINT-STAMINA - ORIGINAL: baller.adjust_stamina_loss(STAMINA_COST_SHOOTING)

...
/obj/machinery/atmospherics/components/unary/heat_exchanger/process_atmos()
	...
	if(combined_heat_capacity > 0)
		var/combined_energy = partnerair_contents.return_temperature() * other_air_heat_capacity + air_heat_capacity * air_contents.return_temperature()
	...
	if(abs(other_old_temperature - partnerair_contents.return_temperature()) > 1)

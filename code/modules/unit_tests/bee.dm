...
/datum/unit_test/beegent/Run()
	...
	var/datum/reagent/picked = GLOB.chemical_reagents_list[/datum/reagent/medicine/fentanyl]
	...
	TEST_ASSERT(dead_bee.reagents.has_reagent(/datum/reagent/medicine/fentanyl), "The bee's corpse did not contain any of the beegent.")

...
/datum/fish_trait
	...
	/// Trait/s to add on apply_to_fish() and remove on remove_from_fish()
...
/datum/fish_trait/proc/apply_to_fish(obj/item/fish/fish, initial = TRUE)
	SHOULD_CALL_PARENT(TRUE)
	if(!initial)
		if(type in fish.fish_traits)
			return FALSE
		if(!isnull(fish_whitelist) && !(fish.type in fish_whitelist))
			return FALSE
...
/datum/fish_trait/proc/remove_from_fish(obj/item/fish/fish)
	SHOULD_CALL_PARENT(TRUE)
	fish.fish_traits -= type
	if(traits_to_add)
		fish.remove_traits(traits_to_add, FISH_TRAIT_DATUM)
	if(length(reagents_to_add))
		UnregisterSignal(fish, COMSIG_GENERATE_REAGENTS_TO_ADD, PROC_REF(add_reagents))
...
/datum/fish_trait/nocturnal/remove_from_fish(obj/item/fish/fish)
	. = ..()
	UnregisterSignal(fish, COMSIG_FISH_LIFE)
...
/datum/fish_trait/emulsijack
	...
	traits_to_add = list(TRAIT_RESIST_EMULSIFY)

/datum/fish_trait/emulsijack/apply_to_fish(obj/item/fish/fish, initial = TRUE)
	. = ..()
	RegisterSignal(fish, COMSIG_FISH_LIFE, PROC_REF(emulsify))

/datum/fish_trait/emulsijack/remove_from_fish(obj/item/fish/fish)
	. = ..()
	UnregisterSignal(fish, COMSIG_FISH_LIFE)
...
/datum/fish_trait/emulsijack/psychic
	...
	traits_to_add = list(TRAIT_RESIST_PSYCHIC)
...
/datum/fish_trait/necrophage/apply_to_fish(obj/item/fish/fish, initial = TRUE)
	. = ..()
	RegisterSignal(fish, COMSIG_FISH_LIFE, PROC_REF(eat_dead_fishes))

/datum/fish_trait/necrophage/remove_from_fish(obj/item/fish/fish)
	. = ..()
	UnregisterSignal(fish, COMSIG_FISH_LIFE)
...
/datum/fish_trait/parthenogenesis
	...
	inheritability = 40
	traits_to_add = list(TRAIT_FISH_SELF_REPRODUCE)
...
/datum/fish_trait/revival/remove_from_fish(obj/item/fish/fish)
	. = ..()
	UnregisterSignal(fish, COMSIG_FISH_STATUS_CHANGED, FISH_TRAIT_DATUM)
...
/datum/fish_trait/predator/apply_to_fish(obj/item/fish/fish, initial = TRUE)
	. = ..()
	RegisterSignal(fish, COMSIG_FISH_LIFE, PROC_REF(eat_fishes))

/datum/fish_trait/predator/remove_from_fish(obj/item/fish/fish)
	. = ..()
	UnregisterSignal(fish, COMSIG_FISH_LIFE)
...
/datum/fish_trait/toxic/apply_to_fish(obj/item/fish/fish, initial = TRUE)
	. = ..()
	...
	if(!initial)
		make_venomous(fish, fish.size, fish.weight)

/datum/fish_trait/toxic/remove_from_fish(obj/item/fish/fish)
	. = ..()
	UnregisterSignal(fish, list(COMSIG_FISH_UPDATE_SIZE_AND_WEIGHT, COMSIG_FISH_STATUS_CHANGED, COMSIG_FISH_EATEN_BY_OTHER_FISH))
	change_venom(fish, reagents_to_add[1], 0.25 * venom_mult, 0.1 * venom_mult, just_remove = TRUE)
...
/datum/fish_trait/toxic/proc/on_status_change(obj/item/fish/source)
	...
	if(!HAS_TRAIT(source, TRAIT_FISH_STINGER))
		return
	change_venom(source, reagents_to_add[1], 0.25 * venom_mult, 0.1 * venom_mult)
...
/datum/fish_trait/territorial/remove_from_fish(obj/item/fish/fish)
	. = ..()
	UnregisterSignal(fish, COMSIG_FISH_LIFE)
...
/datum/fish_trait/lubed/apply_to_fish(obj/item/fish/fish, initial = TRUE)
	. = ..()
	fish.AddComponent(/datum/component/slippery, 8 SECONDS, SLIDE|GALOSHES_DONT_HELP)

/datum/fish_trait/lubed/remove_from_fish(obj/item/fish/fish)
	. = ..()
	qdel(fish.GetComponent(/datum/component/slippery))
...
/datum/fish_trait/amphibious/remove_from_fish(obj/item/fish/fish)
	. = ..()
	fish.required_fluid_type = initial(fish.required_fluid_type)
...
/datum/fish_trait/mixotroph
	...
	traits_to_add = list(TRAIT_FISH_NO_HUNGER)
...
/datum/fish_trait/antigrav/apply_to_fish(obj/item/fish/fish, initial = TRUE)
	. = ..()
	fish.AddElement(/datum/element/forced_gravity, NEGATIVE_GRAVITY)

/datum/fish_trait/antigrav/remove_from_fish(obj/item/fish/fish)
	. = ..()
	fish.RemoveElement(/datum/element/forced_gravity, NEGATIVE_GRAVITY)
...
/datum/fish_trait/anxiety/apply_to_fish(obj/item/fish/fish, initial = TRUE)
	. = ..()
	UnregisterSignal(fish, COMSIG_FISH_LIFE, PROC_REF(on_fish_life))

/datum/fish_trait/anxiety/remove_from_fish(obj/item/fish/fish)
	. = ..()
	UnregisterSignal(fish, COMSIG_FISH_LIFE)
...
/datum/fish_trait/electrogenesis/remove_from_fish(obj/item/fish/fish)
	. = ..()
	UnregisterSignal(fish, list(COMSIG_FISH_FORCE_UPDATED, COMSIG_ITEM_FRIED, TRAIT_FOOD_BBQ_GRILLED))
	fish.update_fish_force()
...
/datum/fish_trait/stinger
	...
	traits_to_add = list(TRAIT_FISH_STINGER)

/datum/fish_trait/stinger/apply_to_fish(obj/item/fish/fish, initial = TRUE)
	. = ..()
	RegisterSignal(fish, COMSIG_FISH_FORCE_UPDATED, PROC_REF(on_force_updated))
	if(!initial)
		fish.update_fish_force()

/datum/fish_trait/stinger/remove_from_fish(obj/item/fish/fish)
	. = ..()
	UnregisterSignal(fish, COMSIG_FISH_FORCE_UPDATED)
	fish.update_fish_force()
...
/datum/fish_trait/toxic_barbs/remove_from_fish(obj/item/fish/fish)
	...
	change_venom(fish, /datum/reagent/toxin/venom, 0.7, 0.3, just_remove = TRUE)
...
/datum/fish_trait/toxic_barbs/proc/on_status_change(obj/item/fish/source)
	...
	if(!HAS_TRAIT(source, TRAIT_FISH_STINGER))
		return
	change_venom(source, /datum/reagent/toxin/venom, 0.7, 0.3)
...
/datum/fish_trait/hallucinogenic/apply_to_fish(obj/item/fish/fish, initial = TRUE)
	. = ..()
	RegisterSignal(fish, COMSIG_FISH_UPDATE_SIZE_AND_WEIGHT, PROC_REF(make_venomous))
	RegisterSignal(fish, COMSIG_FISH_STATUS_CHANGED, PROC_REF(on_status_change))
	if(!initial)
...
/datum/fish_trait/hallucinogenic/remove_from_fish(obj/item/fish/fish)
	. = ..()
	UnregisterSignal(fish, list(COMSIG_FISH_UPDATE_SIZE_AND_WEIGHT, COMSIG_FISH_STATUS_CHANGED))
	change_venom(fish, /datum/reagent/toxin/mindbreaker/fish, 0.7, 0.3, just_remove = TRUE)
...
/datum/fish_trait/hallucinogenic/proc/on_status_change(obj/item/fish/source)
	...
	if(!HAS_TRAIT(source, TRAIT_FISH_STINGER))
		return
	change_venom(source, /datum/reagent/toxin/mindbreaker/fish, 0.7, 0.3)
...
/datum/fish_trait/ink/remove_from_fish(obj/item/fish/fish)
	. = ..()
	UnregisterSignal(fish, list(COMSIG_ATOM_PROCESSED, COMSIG_ITEM_ATTACK_ZONE))
...
/datum/fish_trait/camouflage/apply_to_fish(obj/item/fish/fish, initial = TRUE)
	. = ..()
...
/datum/fish_trait/camouflage/remove_from_fish(obj/item/fish/fish)
	. = ..()
	UnregisterSignal(fish, list(COMSIG_FISH_LIFE, COMSIG_MOVABLE_MOVED, COMSIG_FISH_STATUS_CHANGED))
	reset_alpha(fish)

...
/datum/species/proc/harm(mob/living/carbon/human/user, mob/living/carbon/human/target, datum/martial_art/attacker_style)
	...
	if(kicking || grappled) //kicks and punches when grappling bypass armor slightly.
		...
		target.apply_damage(damage, attack_type, affecting, final_armor_block, attack_direction = attack_direction, sharpness = limb_sharpness, armour_flag = MELEE)
		...
		target.apply_damage(damage, attack_type, affecting, armor_block, attack_direction = attack_direction, sharpness = limb_sharpness, armour_flag = MELEE)
...
/datum/species/proc/body_temperature_damage(mob/living/carbon/human/humi, seconds_per_tick)
	...
	if(humi.coretemperature > bodytemp_heat_damage_limit && !HAS_TRAIT(humi, TRAIT_RESISTHEAT))
		...
		// Apply fire part by part so it can cause injuries and organ overflow.

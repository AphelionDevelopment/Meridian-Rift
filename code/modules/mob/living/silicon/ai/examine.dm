/mob/living/silicon/ai/examine(mob/user)
	...
	if(stat != DEAD)
		...
		if(deployed_shell)
			...
			. += "[src]Core.exe has stopped responding! MeridianOS is searching for a solution to the problem..." // APHELION EDIT CHANGE - MERIDIAN_UI - ORIGINAL: . += "[src]Core.exe has stopped responding! NTOS is searching for a solution to the problem..."

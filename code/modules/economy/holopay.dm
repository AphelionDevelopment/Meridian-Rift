...
/obj/structure/holopay/item_interaction(mob/living/user, obj/item/tool, list/modifiers)
	...
	if(istype(tool, /obj/item/holochip))
		...
		if(!chip.spend(cash_deposit, FALSE))
			...
			return ITEM_INTERACT_BLOCKING
		/// Success: Alert buyer
		alert_buyer(user, cash_deposit, DEPOSIT_LEVY_FRACTION) // APHELION EDIT CHANGE - PERSISTENT_ECONOMY - ORIGINAL: alert_buyer(user, cash_deposit)
		return ITEM_INTERACT_SUCCESS
 ...
 * * levy_fraction - Cut of the payment destroyed as a levy. Deposit rate when the payment was a holochip. // APHELION EDIT ADDITION - PERSISTENT_ECONOMY
 * Returns:
 * * TRUE - alert was successful.
 */
/obj/structure/holopay/proc/alert_buyer(payee, amount, levy_fraction = TRANSACTION_LEVY_FRACTION) // APHELION EDIT CHANGE - PERSISTENT_ECONOMY - ORIGINAL: /obj/structure/holopay/proc/alert_buyer(payee, amount)
	/// Pay the owner
	var/levy = get_transaction_levy(linked_card.registered_account, amount, levy_fraction) // APHELION EDIT ADDITION - PERSISTENT_ECONOMY
	linked_card.registered_account.adjust_money(amount, "Holopay: [name]", levy_fraction) // APHELION EDIT CHANGE - PERSISTENT_ECONOMY - ORIGINAL: linked_card.registered_account.adjust_money(amount, "Holopay: [name]")
	/// Make alerts
	linked_card.registered_account.bank_card_talk("[payee] has deposited [amount] [MONEY_SYMBOL] at your holographic pay stand[levy ? ", less a [levy] [MONEY_SYMBOL] handling fee" : ""].") // APHELION EDIT CHANGE - PERSISTENT_ECONOMY - ORIGINAL: linked_card.registered_account.bank_card_talk("[payee] has deposited [amount] [MONEY_SYMBOL] at your holographic pay stand.")

/obj/item/ammo_casing/proc/fire_casing(atom/target, mob/living/user, params, distro, quiet, zone_override, spread, atom/fired_from)
	...
	//var/next_delay = click_cooldown_override || CLICK_CD_RANGE // NOVA EDIT REMOVAL
	var/next_delay = click_cooldown_override || ((user.get_stamina_loss() <= STAMINA_THRESHOLD_TIRED_CLICK_CD) ? CLICK_CD_RANGE : CLICK_CD_RANGE_TIRED) // NOVA EDIT CHANGE

...
/obj/item/organ/tongue/lizard
	...
	emote_sounds = list(
		/datum/emote/living/scream::key = list(
			...
			'modular_nova/modules/emotes/sound/voice/scream_lizard.ogg', // NOVA EDIT ADDITION
		),
...
/obj/item/organ/tongue/zombie
	...
	emote_sounds = list(
		/datum/emote/living/scream::key = list(
			...
			'modular_nova/modules/emotes/sound/emotes/zombie_scream.ogg', // NOVA EDIT ADDITION
		),
	)
...
/obj/item/organ/tongue/robot
	...
	emote_sounds = list(
		...
		/datum/emote/living/scream::key = 'modular_nova/modules/emotes/sound/voice/scream_silicon.ogg', // NOVA EDIT ADDITION
	)

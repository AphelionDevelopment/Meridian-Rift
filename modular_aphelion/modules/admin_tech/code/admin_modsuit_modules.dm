...
/obj/item/mod/module/infiltrator/admin
	...
	desc = "A permanently fitted cloak that draws no power. Seal the suit and it silences your footsteps, hides your \
		voice, keeps your face out of anyone's examine, and stops a blow to the head registering at all."
	removable = FALSE

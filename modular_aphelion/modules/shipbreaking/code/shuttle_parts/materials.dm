GLOBAL_LIST_INIT(aluminum_recipes, list(
	...
	new/datum/stack_recipe("salvage hand-cart", /obj/structure/salvage_cart, 8, time = 5 SECONDS, crafting_flags = CRAFT_CHECK_DENSITY | CRAFT_ONE_PER_TURF | CRAFT_ON_SOLID_GROUND, category = CAT_MISC),
	))
...
/obj/item/stack/sheet/aluminum
	...
	icon = 'modular_aphelion/modules/shipbreaking/icons/stacks.dmi'
	icon_state = "aluminum"
...
/obj/item/nanocarbon_shard
	...
	icon = 'modular_aphelion/modules/shipbreaking/icons/turfs/walls_misc.dmi'

/turf/closed/wall/mineral/nanocarbon
	...
	icon = 'modular_aphelion/modules/shipbreaking/icons/turfs/nanocarbon_wall.dmi'
...
/turf/closed/wall/mineral/nanocarbon/nodiagonal
	icon = MAP_SWITCH('modular_aphelion/modules/shipbreaking/icons/turfs/nanocarbon_wall.dmi', 'modular_aphelion/modules/shipbreaking/icons/turfs/walls_misc.dmi')
...
/turf/closed/wall/mineral/aluminum
	...
	icon = 'modular_aphelion/modules/shipbreaking/icons/turfs/aluminum_wall.dmi'
...
/turf/open/floor/plating/nanocarbon
	name = "nanocarbon hull"
	desc = "A durable nanocarbon-metal alloy hull used commonly in high endurance ships."
	icon = 'modular_aphelion/modules/shipbreaking/icons/turfs/floors.dmi'
...
/turf/open/floor/plating/aluminum
	...
	icon = 'modular_aphelion/modules/shipbreaking/icons/turfs/aluminum.dmi'

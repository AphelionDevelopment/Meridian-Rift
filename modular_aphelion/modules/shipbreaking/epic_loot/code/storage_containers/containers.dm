/obj/item/storage/epic_loot_medpen_case
	...
	icon = 'modular_aphelion/modules/shipbreaking/epic_loot/icons/storage_items.dmi'
	icon_state = "pencase"
...
/datum/storage/maintenance_loot_structure/epic_loot_the_money
	...
	screen_max_columns = 2
	numerical_stacking = FALSE
	opening_sound = 'modular_aphelion/modules/shipbreaking/epic_loot/sound/wood_crate_1.mp3'

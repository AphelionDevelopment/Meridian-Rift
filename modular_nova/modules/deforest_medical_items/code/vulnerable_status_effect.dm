...
/datum/status_effect/vulnerable_to_damage/on_apply()
	...
	carbon_owner.damage_resistance -= damage_resistance_subtraction
	MODIFY_PHYSIOLOGY(carbon_owner, PHYS_COEFF_BLEED, bleed_modifier)
	return ..()
...
/datum/status_effect/vulnerable_to_damage/on_remove()
	...
	carbon_recoverer.damage_resistance += damage_resistance_subtraction
	MODIFY_PHYSIOLOGY(carbon_recoverer, PHYS_COEFF_BLEED, 1 / bleed_modifier)
	return ..()

...
/obj/structure/millstone/proc/mill_it_up(mob/living/carbon/human/user)
	...
	if(user.get_sprint_stamina_loss() > MILLSTONE_STAMINA_MINIMUM) // NOVA EDIT CHANGE - ORIGINAL: if(user.get_stamina_loss() > MILLSTONE_STAMINA_MINIMUM)
	...
	user.adjust_sprint_stamina_loss(MILLSTONE_STAMINA_USE) // NOVA EDIT CHANGE - ORIGINAL: user.adjust_stamina_loss(MILLSTONE_STAMINA_USE) // Prevents spamming it

/obj/structure/mob_spawner
	...
	var/spawn_delay = 0
	/// What mob to spawn
	var/list/monster_types = list(/mob/living/basic/spider/giant/hunter)
...
/obj/structure/mob_spawner/proc/proximity_trigger(datum/source, atom/movable/arrived, atom/old_loc, list/atom/old_locs) // APHELION EDIT CHANGE - Fleshmind - ORIGINAL: proximity_trigger(datum/source, atom/movable/AM)
	SIGNAL_HANDLER
	if(spawned_mobs >= max_mobs)
		return
	if(spawn_delay > world.time)

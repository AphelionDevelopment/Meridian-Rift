...
/obj/item/microfusion_gun_attachment/barrel/scatter/max
	...
	power_usage = STANDARD_CELL_CHARGE * 0.02
	custom_materials = list(
		/datum/material/iron = HALF_SHEET_MATERIAL_AMOUNT,
		/datum/material/glass = HALF_SHEET_MATERIAL_AMOUNT,
		/datum/material/diamond = HALF_SHEET_MATERIAL_AMOUNT,
...
/obj/item/microfusion_gun_attachment/barrel/repeater/penetrator
	...
	power_usage = STANDARD_CELL_CHARGE * 0.08 // A price to pay to penetrate through armor
	custom_materials = list(
		/datum/material/iron = HALF_SHEET_MATERIAL_AMOUNT,
		/datum/material/glass = HALF_SHEET_MATERIAL_AMOUNT,
		/datum/material/diamond = HALF_SHEET_MATERIAL_AMOUNT,
...
/obj/item/microfusion_gun_attachment/barrel/xray
	...
	heat_addition = 90
	power_usage = STANDARD_CELL_CHARGE * 0.05
...
/obj/item/microfusion_gun_attachment/barrel/lance
	...
	heat_addition = 150
	power_usage = STANDARD_CELL_CHARGE * 0.1
...
/obj/item/microfusion_gun_attachment/undercharger/run_attachment(obj/item/gun/microfusion/microfusion_gun)
	. = ..()
	microfusion_gun.fire_sound = 'modular_nova/modules/modular_weapons/sounds/laser_firing/burn.ogg'

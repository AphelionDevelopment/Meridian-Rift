...
/datum/action/cooldown/fleshmind_flesh_call/Activate(atom/target)
	...
	playsound(owner, 'modular_nova/modules/horrorform/sound/horror_scream.ogg', 100, TRUE)
	StartCooldownSelf()
...
/datum/action/cooldown/fleshmind_plant_weeds
	...
	button_icon = 'modular_nova/modules/fleshmind/icons/fleshmind_structures.dmi'
	background_icon_state = "bg_fugu"

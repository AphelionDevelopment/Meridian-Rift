/mob/living/basic/fleshmind/tyrant
	...
	icon = 'modular_nova/modules/fleshmind/icons/tyrant.dmi'
	icon_state = "tyrant"
	...
	var/projectilesound = 'modular_nova/modules/mounted_machine_gun/sound/50cal_box_01.ogg'
	...
	attack_sound = 'modular_nova/modules/fleshmind/sound/tyrant/mech_punch_slow.ogg'
	...
	emotes = list(
		...
		BB_EMOTE_SOUND = list('modular_nova/modules/fleshmind/sound/tyrant/passive.ogg')
	)
	alert_sounds = list(
		'modular_nova/modules/fleshmind/sound/tyrant/aggro_01.ogg',
		'modular_nova/modules/fleshmind/sound/tyrant/aggro_02.ogg',
		'modular_nova/modules/fleshmind/sound/tyrant/aggro_03.ogg',
		'modular_nova/modules/fleshmind/sound/tyrant/aggro_04.ogg',
		'modular_nova/modules/fleshmind/sound/tyrant/aggro_05.ogg',
		'modular_nova/modules/fleshmind/sound/tyrant/aggro_06.ogg',
		'modular_nova/modules/fleshmind/sound/tyrant/aggro_07.ogg',
		'modular_nova/modules/fleshmind/sound/tyrant/aggro_08.ogg',
		'modular_nova/modules/fleshmind/sound/tyrant/aggro_09.ogg',
		'modular_nova/modules/fleshmind/sound/tyrant/aggro_10.ogg',
		'modular_nova/modules/fleshmind/sound/tyrant/aggro_11.ogg',
	...
	var/static/list/footstep_sounds = list(
		'modular_nova/modules/fleshmind/sound/tyrant/footstep_1.ogg',
		'modular_nova/modules/fleshmind/sound/tyrant/footstep_2.ogg',
		'modular_nova/modules/fleshmind/sound/tyrant/footstep_3.ogg',
		'modular_nova/modules/fleshmind/sound/tyrant/footstep_4.ogg',
		'modular_nova/modules/fleshmind/sound/tyrant/footstep_5.ogg',
		'modular_nova/modules/fleshmind/sound/tyrant/footstep_6.ogg',
	)
	death_sound = 'modular_nova/modules/fleshmind/sound/tyrant/tyrant_death.ogg'
	attack_speak = list(
...
/mob/living/basic/fleshmind/tyrant/setDir(newdir)
	...
	if(COOLDOWN_FINISHED(src, rotate_sound_cooldown))
		playsound(src, 'modular_nova/modules/fleshmind/sound/tyrant/mech_rotation.ogg', 35, TRUE)

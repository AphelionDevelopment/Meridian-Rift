...
/mob/living/basic/fleshmind
	name = "broken"
	icon = 'modular_nova/modules/fleshmind/icons/fleshmind_mobs.dmi'
	icon_state = "error"
	...
	var/list/alert_sounds = list(
		'modular_nova/modules/fleshmind/sound/robot_talk_heavy1.ogg',
		'modular_nova/modules/fleshmind/sound/robot_talk_heavy2.ogg',
		'modular_nova/modules/fleshmind/sound/robot_talk_heavy3.ogg',
		'modular_nova/modules/fleshmind/sound/robot_talk_heavy4.ogg'
	)
	...
	var/list/emotes = list(
		...
		BB_EMOTE_HEAR = list(),
		BB_EMOTE_SOUND = list(
			'modular_nova/modules/fleshmind/sound/robot_talk_light1.ogg',
			'modular_nova/modules/fleshmind/sound/robot_talk_light2.ogg',
			'modular_nova/modules/fleshmind/sound/robot_talk_light3.ogg',
			'modular_nova/modules/fleshmind/sound/robot_talk_light4.ogg',
			'modular_nova/modules/fleshmind/sound/robot_talk_light5.ogg'
		),
	)
...
/mob/living/basic/fleshmind/floater/melee_attack(atom/target, list/modifiers, ignore_cooldown)
	...
	if(ishuman(target_mob) && target_mob.stat < HARD_CRIT && !IS_UNCONSCIOUS(target_mob))
		pre_detonate()
...
/mob/living/basic/fleshmind/hiborg
	...
	alert_sounds = list(
		'modular_nova/modules/fleshmind/sound/hiborg/aggro_01.ogg',
		'modular_nova/modules/fleshmind/sound/hiborg/aggro_02.ogg',
		'modular_nova/modules/fleshmind/sound/hiborg/aggro_03.ogg',
		'modular_nova/modules/fleshmind/sound/hiborg/aggro_04.ogg',
		'modular_nova/modules/fleshmind/sound/hiborg/aggro_05.ogg',
		'modular_nova/modules/fleshmind/sound/hiborg/aggro_06.ogg',
	)
	attack_speak = list(
	...
	emotes = list(
		...
		BB_EMOTE_SAY = list(
			...
			"Glory to the flesh."),
		BB_EMOTE_SOUND = list(
			'modular_nova/modules/fleshmind/sound/hiborg/passive_01.ogg',
			'modular_nova/modules/fleshmind/sound/hiborg/passive_02.ogg',
			'modular_nova/modules/fleshmind/sound/hiborg/passive_03.ogg',
			'modular_nova/modules/fleshmind/sound/hiborg/passive_04.ogg',
			'modular_nova/modules/fleshmind/sound/hiborg/passive_05.ogg',
		)
	)
...
/mob/living/basic/fleshmind/himan
	...
	emotes = list(
		...
		BB_EMOTE_SOUND = list(
			'modular_nova/modules/fleshmind/sound/himan/passive_01.ogg',
			'modular_nova/modules/fleshmind/sound/himan/passive_02.ogg',
			'modular_nova/modules/fleshmind/sound/himan/passive_03.ogg',
			'modular_nova/modules/fleshmind/sound/himan/passive_04.ogg',
		)
	)
	alert_sounds = list(
		'modular_nova/modules/fleshmind/sound/himan/aggro_01.ogg',
		'modular_nova/modules/fleshmind/sound/himan/aggro_02.ogg',
		'modular_nova/modules/fleshmind/sound/himan/aggro_03.ogg',
		'modular_nova/modules/fleshmind/sound/himan/aggro_04.ogg',
		'modular_nova/modules/fleshmind/sound/himan/aggro_05.ogg',
		'modular_nova/modules/fleshmind/sound/himan/aggro_06.ogg',
		'modular_nova/modules/fleshmind/sound/himan/aggro_07.ogg',
		'modular_nova/modules/fleshmind/sound/himan/aggro_08.ogg',
	)
...
/mob/living/basic/fleshmind/phaser/Life(delta_time, times_fired)
	...
	var/target = ai_controller.blackboard[BB_CURRENT_TARGET]
	if(!.) //dead
		return
	...
	if(istype(loc, /obj/structure/closet) && !key)
		for(var/mob/living/iterating_mob in get_hearers_in_view(DEFAULT_VIEW_RANGE / 2, get_turf(src)))
			if(faction_check(iterating_mob.faction, faction))
				continue
			if(IS_UNCONSCIOUS_OR_CRIT(iterating_mob))
				continue
			closet_interaction() // We exit if there are enemies nearby
			ai_controller.set_blackboard_key(BB_CURRENT_TARGET, iterating_mob)
...
/mob/living/basic/fleshmind/mechiver
	...
	alert_sounds = list(
		'modular_nova/modules/fleshmind/sound/mechiver/aggro_01.ogg',
		'modular_nova/modules/fleshmind/sound/mechiver/aggro_02.ogg',
		'modular_nova/modules/fleshmind/sound/mechiver/aggro_03.ogg',
		'modular_nova/modules/fleshmind/sound/mechiver/aggro_04.ogg',
		'modular_nova/modules/fleshmind/sound/mechiver/aggro_05.ogg',
		)
	attack_speak = list(
	...
	emotes = list(
		...
		BB_EMOTE_SOUND = list(
		'modular_nova/modules/fleshmind/sound/mechiver/passive_01.ogg',
		'modular_nova/modules/fleshmind/sound/mechiver/passive_02.ogg',
		'modular_nova/modules/fleshmind/sound/mechiver/passive_03.ogg',
		'modular_nova/modules/fleshmind/sound/mechiver/passive_04.ogg',
		'modular_nova/modules/fleshmind/sound/mechiver/passive_05.ogg',
		'modular_nova/modules/fleshmind/sound/mechiver/passive_06.ogg',
		'modular_nova/modules/fleshmind/sound/mechiver/passive_07.ogg',
		'modular_nova/modules/fleshmind/sound/mechiver/passive_08.ogg',
		)
	)
...
/mob/living/basic/fleshmind/mechiver/proc/get_current_target()
	return ai_controller.blackboard[BB_CURRENT_TARGET]

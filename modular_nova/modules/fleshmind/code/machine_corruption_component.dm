...
#define PAIN_RESPONSE_SOUNDS list('modular_nova/modules/fleshmind/sound/robot_talk_heavy1.ogg', \
...
/datum/component/machine_corruption/proc/handle_destruction(obj/item/target, damage_flag)
	...
	playsound(target, 'modular_nova/modules/fleshmind/sound/sparks_2.ogg', 70, TRUE)
...
/datum/component/machine_corruption/proc/handle_overlays(atom/parent_atom, list/overlays)
	...
	if(starting_up)
		overlays += mutable_appearance('modular_nova/modules/fleshmind/icons/fleshmind_machines.dmi', "rebuild")
	else
		overlays += mutable_appearance('modular_nova/modules/fleshmind/icons/fleshmind_machines.dmi', set_overlay)

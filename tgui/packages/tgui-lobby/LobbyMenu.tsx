...
/* // APHELION EDIT REMOVAL START - LOBBY_MENU_REWORK - APNG flick/icon helper machinery for tg's sprite buttons, no longer needed
...
export function LobbyMenu() {
  ...
  useEffect(() => {
    document.documentElement.style.setProperty(
      '--lobby-bg',
      serverState?.transparent ? 'transparent' : 'black',
    );
